  ...
  <div className="container mx-auto px-5 py-3 flex items-center justify-between md:justify-start">
    ...
    <div className="flex-1 text-center md:text-left md:flex md:items-center md:space-x-6">
      <Link to="/home" className="inline-flex items-center justify-center">
        <img src="/KHELiNFOlogo.png" alt="KHELiNFO Logo" className="h-6 object-contain mx-auto md:mx-0" />
      </Link>
    ...
    <div className="md:ml-auto">
      <button className="inline-flex items-center text-[10px] md:text-sm font-medium bg-gray-100 border border-gray-300 py-[2px] px-[6px] md:py-1 md:px-3 rounded hover:bg-[#012666] hover:text-white transition">
        Login
        <svg
          fill="none"
          stroke="currentColor"
